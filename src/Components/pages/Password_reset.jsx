            ...
            </div>
            {
              confirmToggle ? (
               ...
               <div className="text-center">
                   <h1 className="text-[33px] laptop:text-[40px] text-[#514242]">Password Reset</h1>
               ...
               <div className=" justify-center py-4 md:py-8 flex flex-col items-center gap-8">
                 ...
                 <div className="w-full flex flex-col items-center justify-center py-5">
                        <img src={tick} alt="" className="w-[70px]"/>
                        <h1 className="text-[33px] laptop:text-[35px] text-[#514242]">Password Reset Successful</h1>
